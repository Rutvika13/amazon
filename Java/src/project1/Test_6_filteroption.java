...
public class Test_6_filteroption 
{
	...
	public void filterbtn() throws InterruptedException
	{
		...
		WebElement filterop=	driver.findElement(By.xpath("//input[@class='a-button-input']"));

		
		Assert.assertEquals(filterop.isDisplayed(), true);
